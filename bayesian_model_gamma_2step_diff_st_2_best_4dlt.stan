...
model {
  ...
  // Mandleshwar
  tmp_mf[ind_m1,1:2] = get_log_p_2cov_1_5(covQ[ind_m1,indc[2]], covP[ind_m1,2],mu_mand[1:3], sigma_mand[1:3]);
  tmp_mf[ind_m2,1:2] = get_log_p_2cov_1_5(covQ[ind_m2,indc[2]], covP[ind_m2,2],mu_mand[4:6], sigma_mand[4:6]);
...
generated quantities{
  ...
  // Mandleshwar
  tmp_mf[indp_m1,1:2] = get_log_p_2cov_1_5(covQs[indp_m1,indc[2]], covPs[indp_m1,2],mu_mand[1:3], sigma_mand[1:3]);
  tmp_mf[indp_m2,1:2] = get_log_p_2cov_1_5(covQs[indp_m2,indc[2]], covPs[indp_m2,2],mu_mand[4:6], sigma_mand[4:6]);
