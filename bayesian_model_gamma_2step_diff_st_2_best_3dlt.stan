...
model {
  ...
  // Garudeshwar
  tmp_gf[ind_g1,1:2] = get_log_p_2cov_3_5(covQ[ind_g1,indc[1]], covP[ind_g1,1],mu_garud[1:3], sigma_garud[1:3]);
  tmp_gf[ind_g2,1:2] = get_log_p_2cov_3_5(covQ[ind_g2,indc[1]], covP[ind_g2,1],mu_garud[4:6], sigma_garud[4:6]);
  
  // Mandleshwar
  tmp_mf[ind_m1,1:2] = get_log_p_2cov_2(covQ[ind_m1,indc[2]], covP[ind_m1,2],mu_mand[1:3], sigma_mand[1:3]);
  tmp_mf[ind_m2,1:2] = get_log_p_2cov_2(covQ[ind_m2,indc[2]], covP[ind_m2,2],mu_mand[4:6], sigma_mand[4:6]);
  
  //Handia
  tmp_hf[ind_h1,1:2] = get_log_p_2cov_2_5(covQ[ind_h1,indc[3]], covP[ind_h1,3],mu_han[1:3], sigma_han[1:3]);
  tmp_hf[ind_h2,1:2] = get_log_p_2cov_2_5(covQ[ind_h2,indc[3]], covP[ind_h2,3],mu_han[4:6], sigma_han[4:6]);
  
  //Hoshangabad
  tmp_hof[ind_ho1,1:2] = get_log_p_2cov_2_5(covQ[ind_ho1,indc[4]], covP[ind_ho1,4],mu_hos[1:3], sigma_hos[1:3]);
  tmp_hof[ind_ho2,1:2] = get_log_p_2cov_2_5(covQ[ind_ho2,indc[4]], covP[ind_ho2,4],mu_hos[4:6], sigma_hos[4:6]);
  
  //Sandiya
  tmp_sf[ind_s1,1:2] = get_log_p_2cov_1_5(covQ[ind_s1,indc[5]], covP[ind_s1,5],mu_san[1:3], sigma_san[1:3]);
  tmp_sf[ind_s2,1:2] = get_log_p_2cov_1_5(covQ[ind_s2,indc[5]], covP[ind_s2,5],mu_san[4:6], sigma_san[4:6]);
...
generated quantities{
  ...
  // Garudeshwar
  tmp_gf[indp_g1,1:2] = get_log_p_2cov_3_5(covQs[indp_g1,indc[1]], covPs[indp_g1,1],mu_garud[1:3], sigma_garud[1:3]);
  tmp_gf[indp_g2,1:2] = get_log_p_2cov_3_5(covQs[indp_g2,indc[1]], covPs[indp_g2,1],mu_garud[4:6], sigma_garud[4:6]);
  
  // Mandleshwar
  tmp_mf[indp_m1,1:2] = get_log_p_2cov_2(covQs[indp_m1,indc[2]], covPs[indp_m1,2],mu_mand[1:3], sigma_mand[1:3]);
  tmp_mf[indp_m2,1:2] = get_log_p_2cov_2(covQs[indp_m2,indc[2]], covPs[indp_m2,2],mu_mand[4:6], sigma_mand[4:6]);
  
  //Handia
  tmp_hf[indp_h1,1:2] = get_log_p_2cov_2_5(covQs[indp_h1,indc[3]], covPs[indp_h1,3],mu_han[1:3], sigma_han[1:3]);
  tmp_hf[indp_h2,1:2] = get_log_p_2cov_2_5(covQs[indp_h2,indc[3]], covPs[indp_h2,3],mu_han[4:6], sigma_han[4:6]);
  
  //Hoshangabad
  tmp_hof[indp_ho1,1:2] = get_log_p_2cov_2_5(covQs[indp_ho1,indc[4]], covPs[indp_ho1,4],mu_hos[1:3], sigma_hos[1:3]);
  tmp_hof[indp_ho2,1:2] = get_log_p_2cov_2_5(covQs[indp_ho2,indc[4]], covPs[indp_ho2,4],mu_hos[4:6], sigma_hos[4:6]);
  
  //Sandiya
  tmp_sf[indp_s1,1:2] = get_log_p_2cov_1_5(covQs[indp_s1,indc[5]], covPs[indp_s1,5],mu_san[1:3], sigma_san[1:3]);
  tmp_sf[indp_s2,1:2] = get_log_p_2cov_1_5(covQs[indp_s2,indc[5]], covPs[indp_s2,5],mu_san[4:6], sigma_san[4:6]);
