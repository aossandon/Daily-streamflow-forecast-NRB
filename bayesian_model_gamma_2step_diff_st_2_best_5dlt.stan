...
model {
  ...
  //Sandiya
  tmp_sf[ind_s1,1:2] = get_log_p_2cov_3_5(covQ[ind_s1,indc[5]], covP[ind_s1,5],mu_san[1:3], sigma_san[1:3]);
  tmp_sf[ind_s2,1:2] = get_log_p_2cov_3_5(covQ[ind_s2,indc[5]], covP[ind_s2,5],mu_san[4:6], sigma_san[4:6]);
...
generated quantities{
  ...
  //Sandiya
  tmp_sf[indp_s1,1:2] = get_log_p_2cov_3_5(covQs[indp_s1,indc[5]], covPs[indp_s1,5],mu_san[1:3], sigma_san[1:3]);
  tmp_sf[indp_s2,1:2] = get_log_p_2cov_3_5(covQs[indp_s2,indc[5]], covPs[indp_s2,5],mu_san[4:6], sigma_san[4:6]);
