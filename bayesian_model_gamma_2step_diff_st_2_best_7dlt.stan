...
model {
  ...
  //Handia
  tmp_hf[ind_h1,1:2] = get_log_p_2cov_2(covQ[ind_h1,indc[3]], covP[ind_h1,3],mu_han[1:3], sigma_han[1:3]);
  tmp_hf[ind_h2,1:2] = get_log_p_2cov_2(covQ[ind_h2,indc[3]], covP[ind_h2,3],mu_han[4:6], sigma_han[4:6]);
...
generated quantities{
  ...
  //Handia
  tmp_hf[indp_h1,1:2] = get_log_p_2cov_2(covQs[indp_h1,indc[3]], covPs[indp_h1,3],mu_han[1:3], sigma_han[1:3]);
  tmp_hf[indp_h2,1:2] = get_log_p_2cov_2(covQs[indp_h2,indc[3]], covPs[indp_h2,3],mu_han[4:6], sigma_han[4:6]);
